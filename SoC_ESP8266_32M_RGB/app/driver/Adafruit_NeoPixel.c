...
void ICACHE_FLASH_ATTR getRgb(uint32_t rgb,uint8_t *r, uint8_t *g, uint8_t *b)
{ 
...
void ICACHE_FLASH_ATTR setAllPixelColor(uint32_t rgb)
{ 
  uint8_t i=0;
  uint8_t r, g, b;
